...
namespace App\Forms\EditorArticle;
...
class UpdateEditorArticleForm extends Form
{
    public function buildForm()
    {
        ...
        $this->setBuilder()
            ...
            ->add("annuler", "link", [
                "attr" => [
                    "href" => Router::getRouteByName("actualites.index")->getUrl(),
    ...
    public function configureOptions(): void
    {
        $this
            ...
            ->addConfig("action", Router::getRouteByName("editor.actualites.update", [$this->model->getCategorie()->getSlug(), $this->model->getSlug()])->getUrl());
    }
}